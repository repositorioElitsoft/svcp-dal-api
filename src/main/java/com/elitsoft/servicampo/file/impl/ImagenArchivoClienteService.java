 ...
 *
 */
@Service("imagenArchivoClienteService")
public class ImagenArchivoClienteService implements ImagenArchivoService {
    ...
    @Autowired
    public ImagenArchivoClienteService(ArchivoAlmacenService archivoAlmacenService, ContenedorDirectorio contenedorDirectorio, DirectorioImagenDirectorio directorioImagenDirectorio) {
