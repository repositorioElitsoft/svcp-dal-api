 ...
 *
 */
@Service("imagenArchivoEmpleadoService")
public class ImagenArchivoEmpleadoService implements ImagenArchivoService {
    ...
    @Autowired
    public ImagenArchivoEmpleadoService(ArchivoAlmacenService archivoAlmacenService, ContenedorDirectorio contenedorDirectorio, DirectorioImagenDirectorio directorioImagenDirectorio) {
    ...
    public void subir(byte[] content, String nombreImagen) {
        String objectKey = directorioImagenDirectorio.getDirectorio().concat("/")
                .concat(directorioImagenDirectorio.getEmpleado()).concat("/")
                .concat(nombreImagen);
