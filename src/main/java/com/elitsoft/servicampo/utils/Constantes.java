...
public class Constantes {
    ...
    public static final String CARRITO_ARTICULO_NO_ENCONTRADO_MENSAGE = "Articulo no  encontrado";
    public static final String CARRITO_ARTICULO_EXEDE_LIMITE = "Los articulos de carrito exeden el maximo de articulos";
    public static final String CARRITO_ARTICULO_ENTRADA_INVALIDA = "Entrada de articulo de carrito invalida. Codigo de producto and cantidad son requeridas.";
    public static final String CARRITO_ARTICULO_AGREGAR_EXECPTION = "Error agregando articulo de carrito";
    public static final String CARRITO_ARTICULO_ACTUALIZAR_EXECPTION = "Error actualizando articulo de carrito";
    ...
    public static final String MODULO_ELIMINAR_EXECPTION = "Error eliminando MODULO";
    public static final String MODULO_ENCONTRAR_POR_CLAVE_EXECPTION = "Error encontrando MODULO por clave :";
    public static final String MODULO_OBTENER_TODOS_EXECPTION = "Error obteniendo todos los MODULO";
    public static final String SUBMENU_NO_ENCONTRADO_MENSAGE = "SUBMENU no  encontrado";
    public static final String SUBMENU_AGREGAR_EXECPTION = "Error agregando SUBMENU";
    public static final String SUBMENU_ACTUALIZAR_EXECPTION = "Error actualizando SUBMENU";
    public static final String SUBMENU_ELIMINAR_EXECPTION = "Error eliminando SUBMENU";
    public static final String SUBMENU_ENCONTRAR_POR_CLAVE_EXECPTION = "Error encontrando SUBMENU por clave :";
    public static final String SUBMENU_OBTENER_TODOS_EXECPTION = "Error obteniendo todos los SUBMENU";
    public static final String MENU_NO_ENCONTRADO_MENSAGE = "MENU no  encontrado";
    public static final String MENU_AGREGAR_EXECPTION = "Error agregando MENU";
    public static final String MENU_ACTUALIZAR_EXECPTION = "Error actualizando MENU";
    ...
    public static final String ESTRUCTURAFORMULARIO_ACTUALIZAR_EXECPTION = "Error actualizando ESTRUCTURAFORMULARIO";
    public static final String ESTRUCTURAFORMULARIO_ELIMINAR_EXECPTION = "Error eliminando ESTRUCTURAFORMULARIO";
    public static final String ESTRUCTURAFORMULARIO_ENCONTRAR_POR_CLAVE_EXECPTION = "Error encontrando ESTRUCTURAFORMULARIO por clave :";
    public static final String ESTRUCTURAFORMULARIO_OBTENER_TODOS_EXECPTION = "Error obteniendo todos los ESTRUCTURAFORMULARIO";
    ...
    public static final String TIPODOCUMENTOIDENTIFICACION_VIOLACION_INTEGRIDAD_MENSAGE = "Recurso  TIPODOCUMENTOIDENTIFICACION viola Integridad. ";
    ...
    public static final String CONTRATO_ENTRADA_INVALIDA_MENSAGE = "Entrada de CONTRATO invalida.";
    public static final String CONTRATO_DUPLICADO_MENSAGE = "Recurso  CONTRATO ya existe.";
    public static final String CONTRATO_VIOLACION_INTEGRIDAD_MENSAGE = "Recurso  CONTRATO viola Integridad. ";
    public static final String CONTRATO_NO_ENCONTRADO_MENSAGE = "Recurso CONTRATO no  encontrado";
    public static final String CONTRATO_AGREGAR_MENSAJE = "Error Interno agregando Recurso CONTRATO";
    public static final String CONTRATO_AGREGAR_LOTE_MENSAJE = "Error Interno agregando lote de Recursos CONTRATO";
    ...
    public static final String CONTRATODETALLEPRODUCTO_ENTRADA_INVALIDA_MENSAGE = "Entrada de CONTRATODETALLEPRODUCTO invalida.";
    public static final String CONTRATODETALLEPRODUCTO_DUPLICADO_MENSAGE = "Recurso  CONTRATODETALLEPRODUCTO ya existe.";
    public static final String CONTRATODETALLEPRODUCTO_VIOLACION_INTEGRIDAD_MENSAGE = "Recurso  CONTRATODETALLEPRODUCTO viola Integridad. ";
    public static final String CONTRATODETALLEPRODUCTO_NO_ENCONTRADO_MENSAGE = "Recurso CONTRATODETALLEPRODUCTO no  encontrado";
    public static final String CONTRATODETALLEPRODUCTO_AGREGAR_MENSAJE = "Error Interno agregando Recurso CONTRATODETALLEPRODUCTO";
    public static final String CONTRATODETALLEPRODUCTO_AGREGAR_LOTE_MENSAJE = "Error Interno agregando lote de Recursos CONTRATODETALLEPRODUCTO";
