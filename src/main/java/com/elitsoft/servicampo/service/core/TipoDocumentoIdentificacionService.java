...
public class TipoDocumentoIdentificacionService {
    ...
    public TipoDocumentoIdentificacionDTO agregar(TipoDocumentoIdentificacionDTO tipoDocumentoIdentificacionDTO) throws BaseDatosException, EntradaInvalidadException, RecursoDuplicadoException {
        ...
        if (tipoDocumentoIdentificacionDTO == null) {
            ...
            throw new EntradaInvalidadException(TipoDocumentoIdentificacionError.REQUERIDO.getCodigoError(),
                    Constantes.TIPODOCUMENTOIDENTIFICACION_ENTRADA_INVALIDA_MENSAGE);
        }
        ...
        try {
            ...
            throw new RecursoDuplicadoException(TipoDocumentoIdentificacionError.DUPLICADO.getCodigoError(),
                    Constantes.TIPODOCUMENTOIDENTIFICACION_DUPLICADO_MENSAGE);
            ...
            throw new BaseDatosException(GeneralError.ERROR_INTERNO.getCodigoError(),
                    Constantes.TIPODOCUMENTOIDENTIFICACION_AGREGAR_MENSAJE, e);
        }
    }
    ...
    public void agregarLote(List<TipoDocumentoIdentificacionDTO> tipoDocumentoIdentificacionLoteDTO) throws BaseDatosException, EntradaInvalidadException, RecursoDuplicadoException {
        ...
        try {
            ...
            logeador.error(Constantes.TIPODOCUMENTOIDENTIFICACION_AGREGAR_MENSAJE, e);
            throw new BaseDatosException(GeneralError.ERROR_INTERNO.getCodigoError(),
                    Constantes.TIPODOCUMENTOIDENTIFICACION_AGREGAR_MENSAJE, e);
        }
    }
    ...
    public void actualizar(Long id, TipoDocumentoIdentificacionDTO tipoDocumentoIdentificacionDTO) throws BaseDatosException, RecursoNoEncontradoException, EntradaInvalidadException {
        ...
        if (!id.equals(tipoDocumentoIdentificacionDTO.getId())) {
            ...
            throw new EntradaInvalidadException(TipoDocumentoIdentificacionError.ID_INVALIDO.getCodigoError(),
                    Constantes.TIPODOCUMENTOIDENTIFICACION_ENTRADA_INVALIDA_MENSAGE);
        }
        ...
        try {
            ...
            throw new BaseDatosException(GeneralError.ERROR_INTERNO.getCodigoError(),
                    Constantes.TIPODOCUMENTOIDENTIFICACION_ACTUALIZAR_MENSAJE, e);
        }
    }
     ...
     * @throws BaseDatosException           si ocurre un error de base de datos.
     * @throws RecursoEliminarException     si TipoDocumentoIdentificacion esta asociado a otro recurso
     */
    public void eliminar(Long id) throws RecursoNoEncontradoException, BaseDatosException, RecursoEliminarException {
        ...
        try {
            ...
            logeador.error(Constantes.TIPODOCUMENTOIDENTIFICACION_VIOLACION_INTEGRIDAD_MENSAGE);
            throw new RecursoEliminarException(TipoDocumentoIdentificacionError.INTEGRIDAD_VIOLADA.getCodigoError(),
                    Constantes.TIPODOCUMENTOIDENTIFICACION_VIOLACION_INTEGRIDAD_MENSAGE, e);
        } catch (DataAccessException e) {
            logeador.error(Constantes.TIPODOCUMENTOIDENTIFICACION_ELIMINAR_MENSAJE + ": {}", id, e);
            throw new BaseDatosException(GeneralError.ERROR_INTERNO.getCodigoError(),
                    Constantes.TIPODOCUMENTOIDENTIFICACION_ELIMINAR_MENSAJE, e);
        }
    }
    ...
    public TipoDocumentoIdentificacionDTO encontrarPorClave(Long id) throws BaseDatosException, RecursoNoEncontradoException {
        ...
        try {
            ...
            throw new BaseDatosException(GeneralError.ERROR_INTERNO.getCodigoError(),
                    Constantes.TIPODOCUMENTOIDENTIFICACION_ENCONTRAR_POR_CLAVE_MENSAGE, e);
        }
    }
    ...
    public List<TipoDocumentoIdentificacionDTO> obtenerTodos() throws BaseDatosException {
        ...
        try {
            ...
            throw new BaseDatosException(GeneralError.ERROR_INTERNO.getCodigoError(),
                    Constantes.TIPODOCUMENTOIDENTIFICACION_OBTENER_TODOS_MENSAJE, e);
        }
    }
}