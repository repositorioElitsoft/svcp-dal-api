...
import com.elitsoft.servicampo.service.error.ZonaError;
...
public class ZonaService {
    ...
    public ZonaDTO agregar(ZonaDTO zonaDTO) throws BaseDatosException, EntradaInvalidadException, RecursoDuplicadoException {
        ...
        if (zonaDTO == null) {
            ...
            throw new EntradaInvalidadException(ZonaError.REQUERIDO.getCodigoError(),
                    Constantes.ZONA_ENTRADA_INVALIDA_MENSAGE);
        }
    ...
    public void agregarLote(List<ZonaDTO> zonaLoteDTO) throws BaseDatosException, EntradaInvalidadException, RecursoDuplicadoException {
        ...
        try {
            ...
            throw new BaseDatosException(GeneralError.ERROR_INTERNO.getCodigoError(),
                    Constantes.ZONA_AGREGAR_LOTE_MENSAJE, e);
        }
    }
    ...
    public void actualizar(Long id, ZonaDTO zonaDTO) throws BaseDatosException, RecursoNoEncontradoException, EntradaInvalidadException {
        ...
        if (!id.equals(zonaDTO.getId())) {
            logeador.error(Constantes.ZONA_ENTRADA_INVALIDA_MENSAGE + ": {}, {}", id, zonaDTO.toString());
            throw new EntradaInvalidadException(ZonaError.ID_INVALIDO.getCodigoError(),
                    Constantes.ZONA_ENTRADA_INVALIDA_MENSAGE);
        }
        ...
        try {
            ...
            throw new BaseDatosException(GeneralError.ERROR_INTERNO.getCodigoError(),
                    Constantes.ZONA_ACTUALIZAR_MENSAJE, e);
        }
    }
    ...
    public void eliminar(Long id) throws RecursoNoEncontradoException, BaseDatosException, RecursoEliminarException {
        ...
        try {
            ...
            logeador.error(Constantes.ZONA_VIOLACION_INTEGRIDAD_MENSAGE);
            throw new RecursoEliminarException(ZonaError.INTEGRIDAD_VIOLADA.getCodigoError(),
                    Constantes.ZONA_VIOLACION_INTEGRIDAD_MENSAGE, e);
        } catch (DataAccessException e) {
            logeador.error(Constantes.ZONA_ELIMINAR_MENSAJE + ": {}", id, e);
            throw new BaseDatosException(GeneralError.ERROR_INTERNO.getCodigoError(),
                    Constantes.ZONA_ELIMINAR_MENSAJE, e);
        }
    }
    ...
    public ZonaDTO encontrarPorClave(Long id) throws BaseDatosException, RecursoNoEncontradoException {
        ...
        try {
            ...
            if (zonaDTO != null) {
                ...
                throw new RecursoNoEncontradoException(ZonaError.NO_ENCONTRADO.getCodigoError(),
                        Constantes.ZONA_NO_ENCONTRADO_MENSAGE);
            }
            ...
            throw new BaseDatosException(GeneralError.ERROR_INTERNO.getCodigoError(),
                    Constantes.ZONA_ENCONTRAR_POR_CLAVE_MENSAGE, e);
        }
    }
    ...
    public List<ZonaDTO> obtenerTodos() throws BaseDatosException {
        ...
        try {
            ...
            throw new BaseDatosException(GeneralError.ERROR_INTERNO.getCodigoError(),
                    Constantes.ZONA_OBTENER_TODOS_MENSAJE, e);
        }
    }
}