...
public class TipoServicioMobileController {
    ...
    public ResponseEntity<ApiEnityResponse<TipoServicioDTO>> agregar(@RequestBody TipoServicioDTO tipoServicioDto) {
        ...
        try {
            return ResponseEntity.status(HttpStatus.CREATED).body(new ApiEnityResponse<>(tipoServicioMobileService.agregar(tipoServicioDto))); // Retorna  201 Created
        }
    ...
    public ResponseEntity<ApiEnityResponse<String>> agregarLote(@RequestBody List<TipoServicioDTO> tipoServicioLoteDto) {
    ...
    public ResponseEntity<ApiEnityResponse<String>> actualizarLote(@RequestBody List<TipoServicioDTO> tipoServicioLoteDto) {
    ...
    public ResponseEntity<ApiEnityResponse<TipoServicioDTO>> encontrarPorClave(@PathVariable Long id) {
        ...
        try {
            return ResponseEntity.ok(new ApiEnityResponse<>(tipoServicioMobileService.encontrarPorClave(id))); // Retorna  200 OK
        } catch (BaseDatosException e) {
    ...
    public ResponseEntity<ApiEnityResponse<List<TipoServicioDTO>>> obtenerTodos() {
        ...
        try {
            return ResponseEntity.ok(new ApiEnityResponse<>(tipoServicioMobileService.obtenerTodos())); // Retorna  200 OK
        } catch (BaseDatosException e) {
            return ResponseEntity.internalServerError().body(new ApiEnityResponse<>(null, e.getErrorCode(), e.getMessage())); // Retorna  500 Internal Server Error
        }
    }
