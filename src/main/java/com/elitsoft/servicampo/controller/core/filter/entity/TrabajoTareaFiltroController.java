...
public class TrabajoTareaFiltroController {

    @Autowired
    private TrabajoTareaFiltroService trabajoTareaFiltroService; //Logica de Negocio de Filtrado del Core Service

    private static final Logger logeador = LoggerFactory.getLogger(TrabajoTareaFiltroController.class); //Logback

    @GetMapping(value = "/trabajos-tareas", consumes = MediaType.APPLICATION_JSON_VALUE)
    @Operation(summary = "Filtra un trabajotarea", description = "Filtra y hace paginado de trabajotarea por atributos")
    @ApiResponses(value = {
