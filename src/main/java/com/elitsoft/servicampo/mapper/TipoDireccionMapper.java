...
public interface TipoDireccionMapper {
    ...
    /**
     * Encuentra lista TipoDireccion en la base de datos asociados a #EntityRelacionado#.
     ...
     * @return Lista entidad TipoDireccion encontrado, o null si no es encontrado.
     */
    //List<TipoDireccion>  encontrarPor#EntityRelacionado#(Long #entityRelacionado#Id, boolean limite);
