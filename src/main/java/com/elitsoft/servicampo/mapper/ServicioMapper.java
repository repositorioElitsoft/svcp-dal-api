...
public interface ServicioMapper {
    ...
    /**
     * Encuentra lista Servicio en la base de datos asociados a #EntityRelacionado#.
     ...
     * @return Lista entidad Servicio encontrado, o null si no es encontrado.
     */
//    List<Servicio>  encontrarPor#EntityRelacionado#(Long #entityRelacionado#Id, boolean limite);
